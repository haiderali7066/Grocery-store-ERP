...
import { LayoutDashboard, ShoppingCart, Package, Boxes, Tags, Users, FileText, Settings, LogOut, BarChart3, Zap, RefreshCw, Settings as WifiSettings, DollarSign, TrendingUp } from 'lucide-react';
...
const menuItems = [
  ...
  { label: 'Bundles', icon: Boxes, href: '/admin/bundles' },
  ...
  { label: 'Refund Requests', icon: RefreshCw, href: '/admin/refunds' },
